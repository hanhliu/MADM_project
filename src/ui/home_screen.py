...
class HomeScreen(QWidget):
    ...
    def load_ui_list(self):
        ...
        self.table_topic.setHorizontalHeaderLabels(["STT", "Đề tài", "Lĩnh vực", "Ngày diễn ra", "Tác giả"])
        # Populate table
        ...
        self.table_reviewer.setHorizontalHeaderLabels(["STT", "Tên", "Lĩnh vực nghiên cứu", "Học vị", "Ngày sẵn sàng", "Đề tài", "Rate"])
        # Populate table
    ...
    def setup_table_width(self, width):
        ...
        self.table_topic.setColumnWidth(4, 0.28 * width)  # Author

        self.table_reviewer.setColumnWidth(0, 0.025 * width)  # No
        self.table_reviewer.setColumnWidth(1, 0.1 * width)  # Name
        self.table_reviewer.setColumnWidth(2, 0.15 * width)  # Field
        self.table_reviewer.setColumnWidth(3, 0.1 * width)  # Degree
        self.table_reviewer.setColumnWidth(4, 0.2 * width)  # Availability
        self.table_reviewer.setColumnWidth(5, 0.25 * width)  # Conference topic
        self.table_reviewer.setColumnWidth(6, 0.07 * width)  # Average Rating
